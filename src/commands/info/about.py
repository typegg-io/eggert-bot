...
class About(Command):
    ...
    async def about(self, ctx):
        message = Message(ctx, Page(
            ...
            description=(
                f""
                f"{self.bot.user.mention} is a typing statistics Discord bot. It is designed to enhance the "
                f"<:typegg_logo:1421559259929382923> TypeGG experience, providing detailed insights and features.\n\n"
